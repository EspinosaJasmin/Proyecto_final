...
class VentanaBienvenida(tk.Tk):
    ...
    def __init__(self):
        ...
        self.config(bg="#e0f7fa")  # Light blue background color
        ...
        self.btn_ir_registro = tk.Button(self, text="Agendar Cita",
                                         font=("Helvetica", 14), bg="#009688", fg="white", # Teal
...
class VentanaRegistroCitas(tk.Tk):
    ...
    def __init__(self):
        ...
        tk.Label(self, text="Registro de Citas Médicas",
                 font=("Helvetica", 18, "bold"), fg="#1a237e", bg="#e3f2fd").pack(pady=20) # Dark blue
    ...
    def validar_nombre(self, nombre):
        ...
        return re.fullmatch(r'^[a-zA-ZáéíóúÁÉÍÓÚñÑÑüÜ\s]+$', nombre)
    ...
    def registrar_cita(self):
        ...
        if not self.validar_nombre(nombre):
            messagebox.showerror("Error en el Nombre", "El nombre del paciente solo debe contener letras y espacios.")
            return
        ...
        numero_camilla = camillas_asignadas
...
class VentanaVerCitas(tk.Toplevel):
    ...
    def mostrar_citas(self):
        ...
        # Tag configuration for styling text
